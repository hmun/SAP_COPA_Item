...
Function delSAPCommandbar()
    ...
    For Each aCmdBar In aCmdBars
      If aCmdBar.Name = "SAPCOPAPosting" Then
        aCmdBarExists = True
        Exit For
      End If
    Next
...
Attribute addSAPCommandbar.VB_ProcData.VB_Invoke_Func = " \n14"
    ...
    Else
      Set aCmdBar = aCmdBars.Add("SAPCOPAPosting", msoBarTop, , True)
        Dim aButton As CommandBarControl
        Set aButton = aCmdBar.Controls.Add(msoControlButton)
        With aButton
            .Style = msoButtonCaption
            .Caption = "COPA Buchung"
            .TooltipText = "SAP-COPA Einzelposten verbuchen"
            .OnAction = "SAP_COPA_Post"
        End With
        Set aButton = aCmdBar.Controls.Add(msoControlButton)
        With aButton
            .BeginGroup = True
