...
Sub SAP_COPA_Post()
    Dim aSAPCOPAActuals As New SAPCOPAActuals
    ...
    Do
        If Left(Cells(i, maxJ), 7) <> "Success" Then
            ...
            Do
                ...
                aSAPCOPAItem.create aFIELDNAME, aVALUE, aCURRENCY
            ...
            If aLineCnt >= aLines Then
                ...
                aRetStr = aSAPCOPAActuals.PostCostingBasedData(aOperatingConcern, aData)
